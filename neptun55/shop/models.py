...
class Boat(models.Model):
    ...
    boat_manufacturer = models.ForeignKey(Manufacturer, verbose_name="Производитель", on_delete=models.SET_NULL, null=True) # производитель лодки.
...
class Reviews(models.Model):
    ...
    product = models.ForeignKey(Boat, verbose_name="Лодка", on_delete=models.CASCADE)
...
class VideosBoats(models.Model):
    video = models.CharField("Ссылка на видеоролик", max_length=100)
    boat = models.ForeignKey(Boat, verbose_name="Лодка", on_delete= models.CASCADE, null=True)
    class Meta:
        verbose_name = "Видео"
