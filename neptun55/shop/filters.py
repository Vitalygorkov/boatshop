...
class BoatFilter(django_filters.FilterSet):
    ...
    length__gt = django_filters.NumberFilter(field_name='length', lookup_expr='gt', label='Длина(см) от:')
    length__lt = django_filters.NumberFilter(field_name='length', lookup_expr='lt', label='Длина(см) до:')
    ...
    cockpit_length__gt = django_filters.NumberFilter(field_name='cockpit_length', lookup_expr='gt', label='Длина кокпита (см) от:')
    cockpit_length__lt = django_filters.NumberFilter(field_name='cockpit_length', lookup_expr='lt', label='Длина кокпита (см) до:')
    cockpit_width__gt = django_filters.NumberFilter(field_name='cockpit_width', lookup_expr='gt', label='Длина кокпита (см) от:')
